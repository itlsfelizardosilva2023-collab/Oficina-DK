...
<?php
 require_once "./models/Atualizacao_de_funcionario_models.php";
...
<html lang="pt">
 <head>
    ...
    <title>Atualização do funcionarios</title>
    ...
    <div class="container">
           <?php include_once('sidebar.php');?>
            ...
            <div class="right">
              ...
              <h2>Actualização do Funcionario</h2>

            
                    <form method="POST">

                    <input type="hidden" name="id" value="<?php echo $funcionarios['id_funcionario']; ?>">

                    <input type="text" name="nome" value="<?php echo $funcionarios['nome']; ?>" required>

                    <input type="email" name="email" value="<?php echo $funcionarios['email']; ?>" required>

                    <input type="text" name="endereco" value="<?php echo $funcionarios['endereco']; ?>" required>
                    
                    <input type="text" name="telefone" value="<?php echo $funcionarios['telefone']; ?>" required>

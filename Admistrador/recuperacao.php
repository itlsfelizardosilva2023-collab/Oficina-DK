...
<?php
include_once("./models/recuperacao_models.php");
?>
...
<html lang="pt">
 <head>
    ...
    <link rel="stylesheet" href="../views/css/recuperacao.css?v=2.1">
  </head>
   <body>

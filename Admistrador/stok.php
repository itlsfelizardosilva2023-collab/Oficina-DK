...
<html lang="pt">
 <head>
    ...
    <link rel="stylesheet" href="../views/css/stok.css?v=1.1">
...
<?php } ?>
            ...
            <div class="Recent-Order">
                <h2>Materias e peças em Stock</h2>
                    ...
                    <div class="search-container">
                       <input type="text" id="pesquisa" placeholder="Pesquisar produto..." class="searchInput" >
        ...
        <div class="btn-add">
    <button class="btn-add" onclick="abrirModalAddProduto()">
        ...
        <div class="modal-overlay" id="modalAddProduto" style="display:none;">
            <div class="containerc">
                <div class="right">
                    <span class="modal-fechar" onclick="fecharModalAddProduto()">&times;</span>
                    ...
                    <form method="POST">
                        ...
                        <input type="date" name="data_expiracao" placeholder="Data de Expiração">
                ...
                <script id="fade-js">
                        ...
                        document.querySelectorAll('.linha-produto').forEach(function(linha) {
...
document.getElementById('modalAddProduto').addEventListener('click', function(e) {
    if (e.target === this) {

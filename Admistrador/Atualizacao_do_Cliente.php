...
<?php
  require_once "./models/Atualizacao_do_cliente_models.php";
  session_start();
?>
            ...
            <div class="right">
              ...
              <h2>Actualização da Cliente</h2>
                   ...
                   <form method="POST">
                    ...
                    <input type="text" name="endereco" value="<?php echo $clientes['endereco']; ?>" required >

                    <input type="text" name="telefone" value="<?php echo $clientes['telefone']; ?>" required maxlength="9">

                     <input type="text" name="numero_bi" value="<?php echo $clientes['numero_bi']; ?>" required maxlength="14">
